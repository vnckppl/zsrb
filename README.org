...
- [[#Simple%20ZSRB][Simple ZSRB]]
- [[#Complex%20ZSRB][Complex ZSRB]]
...
- [[#Simple%20ZSRB][Simple ZSRB]] (legacy option for validation of / comparison with other work)
- [[#Complex%20ZSRB][Complex ZSRB]] (preferred option that allows taking into account covariates)
